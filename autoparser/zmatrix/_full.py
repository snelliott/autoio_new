...
def read(string,
    ...
    if last:
        mat_str, setv_str = apf.last_capture(block_ptt_, string)
    else:
        mat_str, setv_str = apf.first_capture(block_ptt_, string)
    ...
    val_dct = _setval_read(
        setv_str,
        name_ptt=name_ptt, val_ptt=val_ptt, entry_sep_ptt=setv_entry_sep_ptt,
        entry_start_ptt=setv_entry_start_ptt, sep_ptt=setv_sep_ptt)
