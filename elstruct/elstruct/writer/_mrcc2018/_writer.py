...
from elstruct.writer._mrcc2018._par import REF_DCT, OPTION_EVAL_DCT
...
def write_input(job_key, geo, charge, mult, method, basis, orb_restricted,
    ...
    fill_dct = {
        ...
        fill.TemplateKey.BASIS: mrcc_basis,
        fill.TemplateKey.SCF_METHOD: mrcc_scf_method,
        fill.TemplateKey.SCF_OPTIONS: '\n'.join(scf_options),
        fill.TemplateKey.CORR_METHOD: mrcc_corr_method,
