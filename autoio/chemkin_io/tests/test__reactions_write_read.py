...
ARRHENIUS_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), (None,)):
                           (([1E+15, 0.00, 25000], None, None, None, None, None),)}

LINDEMANN_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), ('(+M)',)):
                           (([1E+15, 0.00, 25000], [1E+15, 0.00, 25000], None, None, None,
                               {'AR': 1.4, 'N2': 1.7}),)}

TROE_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), ('(+AR)',)):
                           (([1E+15, 0.00, 25000], [1E+15, 0.00, 25000], [0.95, 1E-30, 8000], None, None, None),)}

CHEBYSHEV_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), ('(+N2)',)):
...
PLOG_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), (None,)):
...
DUPLICATE_ARRHENIUS_RXN_PARAM_DCT = {(('H', 'O2'), ('HO2'), ('+M',)):
                           (([1E+15, 0.00, 25000], None, None, None, None, None),
                            ([1E+15, 0.00, 25000], None, None, None, None, None),)}

DUPLICATE_PLOG_RXN_PARAM_DCT = {(('H', 'O2'), ('OH', 'O'), (None,)):
                           (([1E+15, 0.00, 25000], None, None, None,
                               {0.1: [1E+15, 0.00, 25000],
